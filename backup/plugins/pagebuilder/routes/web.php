...
Route::group(['prefix' => getAdminPrefix(), 'middleware' => 'auth'], function () {
    ...
    Route::middleware(['can:Manage Tlcommerce Page Builder'])->group(function () {
        ...
        Route::post('page-builder/section/create', [PageBuilderController::class, 'newSection'])->name('plugin.builder.pageSection.new')->middleware('demo');
        ...
        Route::post('page-builder/widget/remove', [PageBuilderController::class, 'removeWidget'])->name('plugin.builder.pageSection.widget.remove')->middleware('demo');
        ...
        Route::post('page-builder/widget/order', [PageBuilderController::class, 'orderWidget'])->name('plugin.builder.pageSection.widget.order')->middleware('demo');
