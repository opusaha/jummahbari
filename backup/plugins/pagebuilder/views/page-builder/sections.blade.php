            ...
            <div class="card mb-30" id="properties-section">
                ...
                <div class="card-body">
                    ...
                    <div id="widget-list-body" class="widget-list-wrapper">
                        ...
                        <div class="widget-list custom-scroll row mx-0">
                            @foreach ($widgets as $widget)
                                @if (array_key_exists($widget['name'], $plugin_dependencies_widgets))
                                    @if (!isActivePlugin($plugin_dependencies_widgets[$widget['name']]))
                                        @continue
                                    @endif
                                @endif

                                <div class="widget-single mb-2 col-lg-6 mb-2 p-0 px-2" data-widget="{{ $widget['name'] }}"
                                    ...
                                    <div class="widget-content d-flex justify-content-between align-items-center">
                                        ...
                                        <i class="fz-20 icofont-drag3 text-body"></i>
                                    </div>
                                </div>
                            @endforeach
                        </div>
