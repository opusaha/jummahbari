            ...
            <div class="input-group addon">
                <div class="input-group-append">
                    <input type="color" class="input-group-text theme-input-style2 color-picker mr-n1"
                        id="colorPicker"
                        value="{{ isset($properties['background_color']) ? $properties['background_color'] : '#000000' }}">
                </div>
                <input type="text" name="background_color" class="color-input form-control" placeholder="#000000"
                    value="{{ isset($properties['background_color']) ? $properties['background_color'] : '' }}">
