                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <label for="blog_colum_1">
                                <img src="{{ asset('/themes/fashion-theme/public/blog/images/layout/1column.png') }}"
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <label for="blog_colum_2">
                                <img src="{{ asset('themes/fashion-theme/public/blog/images/layout/2column.png') }}"
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            <label for="blog_colum_3">
                                <img src="{{ asset('themes/fashion-theme/public/blog/images/layout/3column.png') }}"
    ...
    <div class="tab-pane fade" id="style" role="tabpanel" aria-labelledby="style-tab">
        ...
        <div class="form-group mb-3">
            ...
            <div class="input-group addon">
                ...
                <input type="text" name="title_color_c_" class="color-input form-control" placeholder="#000000"
        ...
        <div class="form-group mb-3">
            ...
            <div class="input-group addon">
                ...
                <input type="text" name="title_hover_color_c_" class="color-input form-control"
                    placeholder="#000000"
        ...
        <div class="form-group mb-3">
            ...
            <div class="input-group addon">
                ...
                <input type="text" name="button_color_c_" class="color-input form-control" placeholder="#000000"
        ...
        <div class="form-group mb-3">
            ...
            <div class="input-group addon">
                ...
                <input type="text" name="button_hover_color_c_" class="color-input form-control"
                    placeholder="#000000"
