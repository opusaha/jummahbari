        ...
        <div class="form-group mb-20">
            ...
            <div class="col-sm-12">
                <div class="input-group addon">
                    ...
                    <input type="text" name="text_color_c_" class="color-input form-control"
                        placeholder="#000000"
        ...
        <div class="form-group mb-20">
            ...
            <div class="col-sm-12">
                <div class="input-group addon">
                    ...
                    <input type="text" name="play_button_color_c_" class="color-input form-control"
                        placeholder="#000000"
        ...
        <div class="form-group mb-20">
            ...
            <div class="col-sm-12">
                <div class="input-group addon">
                    ...
                    <input type="text" name="play_button_border_color_c_" class="color-input form-control"
                        placeholder="#000000"
        ...
        <div class="form-group mb-20">
            ...
            <div class="col-sm-12">
                <div class="input-group addon">
                    ...
                    <input type="text" name="button_color_c_" class="color-input form-control"
                        placeholder="#000000"
