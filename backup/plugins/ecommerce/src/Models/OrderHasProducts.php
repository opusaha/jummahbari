...
class OrderHasProducts extends Model
{
    ...
    public function canReturn()
    {
        ...
        $time = (int) SettingsRepository::getEcommerceSetting('return_order_time_limit');
