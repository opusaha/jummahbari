...
use Plugin\Ecommerce\Http\Requests\CurrencyRequest;
...
class CurrencyController extends Controller
{
    ...
    {
        return view('plugin/ecommerce::currency.add_currency');
    }
    ...
    public function storeCurrency(CurrencyRequest $request)
    {
        try {
            ...
            return redirect()->route('plugin.ecommerce.ecommerce.all.currencies');
        } catch (Exception $ex) {
    ...
    public function allCurrencies()
    {
        ...
        return view('plugin/ecommerce::currency.index', compact('all_currencies'));
    }
    ...
    public function editCurrency($id)
    {
        try {
            ...
            return view('plugin/ecommerce::currency.edit_currency', compact('currency'));
        } catch (\Throwable $th) {
    ...
    public function updateCurrency(CurrencyRequest $request)
    {
        try {
            ...
            return redirect()->route('plugin.ecommerce.ecommerce.edit.currency', $request['id']);
        } catch (Exception $e) {
            DB::rollBack();
