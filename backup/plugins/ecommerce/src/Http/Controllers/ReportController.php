...
use Plugin\Ecommerce\Repositories\ReportRepository;
...
class ReportController extends Controller
{
    ...
    public function productReport(Request $request)
    {
        ...
        return view('plugin/ecommerce::reports.products_report')->with(
            [
                'data' => $report_data,
    ...
    public function productWishlistReport(Request $request)
    {
        ...
        return view('plugin/ecommerce::reports.products_wishlist_report')->with(
            [
                'data' => $report_data,
                'categories' => $categories
            ]
    ...
    public function userKeywordSearch(Request $request)
    {
        ...
        return view('plugin/ecommerce::reports.keyword_search_report')->with(
            [
                'data' => $report_data,
                'categories' => $categories
            ]
