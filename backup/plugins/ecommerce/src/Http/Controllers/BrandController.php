...
use Plugin\Ecommerce\Http\Requests\BrandRequest;
...
class BrandController extends Controller
{
    ...
    public function productBrands()
    {
        ...
        return view('plugin/ecommerce::products.brands.index')->with(
            [
                'brands' => $brands
            ]
        );
    ...
    public function storeNewProductBrand(BrandRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.brand.list');
        } else {
    ...
    {
        return view('plugin/ecommerce::products.brands.edit_brand')->with(
            [
    ...
    public function updateProductBrand(BrandRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.brand.edit', ['id' => $request['id'], 'lang' => $request['lang']]);
        } else {
