...
use Plugin\Ecommerce\Repositories\WishlistRepository;
use Plugin\Ecommerce\Http\Requests\CustomerUpdateRequest;
...
class CustomerController extends Controller
{
    ...
    public function customers(Request $request)
    {
        ...
        return view('plugin/ecommerce::customers.index')->with(
            [
                'customers' => $customers
            ]
        );
    ...
    public function customerDetails($id)
    {
        ...
        return view('plugin/ecommerce::customers.details')->with(
            [
