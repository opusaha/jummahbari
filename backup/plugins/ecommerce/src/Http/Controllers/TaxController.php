...
use Plugin\Ecommerce\Http\Requests\TaxRateRequest;
use Plugin\Ecommerce\Repositories\VatTaxRepository;
use Plugin\Ecommerce\Repositories\ProductRepository;
use Plugin\Ecommerce\Http\Requests\TaxProfileRequest;
use Plugin\Ecommerce\Repositories\ShippingRepository;
use Plugin\Ecommerce\Http\Requests\ShippingZoneTaxRequest;
...
class TaxController extends Controller
{
    ...
    {
        return view('plugin/ecommerce::taxes.index')->with(
            [
    ...
    public function deleteTaxProfile(Request $request)
    {
        ...
        if ($res) {
            ...
            return to_route('plugin.ecommerce.ecommerce.settings.taxes.list');
        }
        if (!$res) {
    ...
    {
        return view('plugin/ecommerce::taxes.manage_tax_rates')->with(
            [
