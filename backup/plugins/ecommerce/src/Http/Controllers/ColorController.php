...
use Plugin\Ecommerce\Http\Requests\ColorRequest;
...
class ColorController extends Controller
{
    ...
    {
        return view('plugin/ecommerce::products.colors.index')->with(
            [
    ...
    public function storeColor(ColorRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.colors.list');
        } else {
    ...
    {
        return view('plugin/ecommerce::products.colors.edit_color')->with(
            [
