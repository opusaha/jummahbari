...
use Plugin\Ecommerce\Http\Requests\ProductCategoryRequest;
...
class CategoryController extends Controller
{
    ...
    public function categories()
    {
        ...
        return view('plugin/ecommerce::products.categories.index')->with(
            [
    ...
    public function newCategory()
    {
        ...
        return view('plugin/ecommerce::products.categories.new_category')->with(
            [
                'categories' => $categories
            ]
        );
    ...
    public function newCategoryStore(ProductCategoryRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.category.list');
        } else {
    ...
    {
        return view('plugin/ecommerce::products.categories.edit_category')->with(
            [
