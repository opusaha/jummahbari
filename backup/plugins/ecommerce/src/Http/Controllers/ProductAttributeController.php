...
use Plugin\Ecommerce\Http\Requests\ProductAttributeRequest;
use Plugin\Ecommerce\Repositories\ProductAttributeRepository;
use Plugin\Ecommerce\Http\Requests\ProductAttributeValueRequest;
...
class ProductAttributeController extends Controller
{
    ...
    {
        return view('plugin/ecommerce::products.attributes.index')->with(
            [
    ...
    public function storeAttribute(ProductAttributeRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.attributes.list');
        } else {
    ...
    {
        return view('plugin/ecommerce::products.attributes.edit_attribute')->with(
            [
    ...
    {
        return view('plugin/ecommerce::products.attributes.attribute_values')->with(
            [
                'attribute_details' => $this->attribute_repository->attributeDetails($id)
            ]
        );
    ...
    public function attributeValuesStore(ProductAttributeValueRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.attributes.values', $request->attribute_id);
        } else {
    ...
    {
        return view('plugin/ecommerce::products.attributes.edit_attribute_value')->with(
            [
