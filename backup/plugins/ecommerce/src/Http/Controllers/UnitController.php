...
use Plugin\Ecommerce\Http\Requests\UnitRequest;
...
class UnitController extends Controller
{
    ...
    {
        return view('plugin/ecommerce::products.units.index')->with(
            [
    ...
    public function storeUnit(UnitRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.units.list');
        } else {
    ...
    {
        return view('plugin/ecommerce::products.units.edit_unit')->with(
            [
