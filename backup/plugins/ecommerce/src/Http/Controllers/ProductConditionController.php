...
use Plugin\Ecommerce\Http\Requests\ProductConditionRequest;
...
class ProductConditionController extends Controller
{
    ...
    {
        return view('plugin/ecommerce::products.conditions.index')->with(
            [
    ...
    public function storeCondition(ProductConditionRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.conditions.list');
        } else {
    ...
    {
        return view('plugin/ecommerce::products.conditions.edit_condition')->with(
            [
