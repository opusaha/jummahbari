...
use Plugin\Ecommerce\Http\Requests\CollectionRequest;
...
class ProductCollectionController extends Controller
{
    ...
    {
        return view('plugin/ecommerce::products.collections.index')->with(
            [
    ...
    {
        return view('plugin/ecommerce::products.collections.create');
    }
    /**
     * 
    ...
    public function storeNewCollection(CollectionRequest $request)
    {
        ...
        if ($collection_id != null) {
            ...
            return redirect()->route('plugin.ecommerce.product.collection.products', $collection_id);
        } else {
    ...
    {
        return view('plugin/ecommerce::products.collections.edit')->with(
            [
    ...
    public function updateCollection(CollectionRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.product.collection.list');
        } else {
    ...
    {
        return view('plugin/ecommerce::products.collections.products')->with(
            [
                'collection_details' => $this->collection_repository->collectionDetails($id),
    ...
    public function storeCollectionProducts(Request $request)
    {
        if ($request->has('products')) {
            ...
            if ($res == true) {
                ...
                return redirect()->route('plugin.ecommerce.product.collection.products', $request['collection_id']);
            } else {
                toastNotification('error', translate('Action failed'), 'Failed');
                return redirect()->back();
            }
