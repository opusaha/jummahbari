...
use Plugin\Ecommerce\Http\Requests\StateRequest;
use Plugin\Ecommerce\Http\Requests\CitiesRequest;
use Plugin\Ecommerce\Http\Requests\CountryRequest;
...
class LocationController extends Controller
{
    ...
    {
        return view('plugin/ecommerce::shipping.locations.country.index')->with(
            [
    ...
    {
        return view('plugin/ecommerce::shipping.locations.country.add_new');
    }
    /**
     * Store new country
     * 
    ...
    public function storeNewCountry(CountryRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.shipping.locations.country.list');
        } else {
    ...
    {
        return view('plugin/ecommerce::shipping.locations.country.edit')->with(
            [
    ...
    public function updateCountry(CountryRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.shipping.locations.country.edit', ['id' => $request['id'], 'lang' => $request['lang']]);
        } else {
    ...
    {
        return view('plugin/ecommerce::shipping.locations.state.index')->with(
            [
    ...
    {
        return view('plugin/ecommerce::shipping.locations.state.add_new')->with(
            [
    ...
    public function storeState(StateRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.shipping.locations.states.list');
        } else {
    ...
    {
        return view('plugin/ecommerce::shipping.locations.state.edit')->with(
            [
                'countries' => $this->location_repository->countries(),
    ...
    public function updateState(StateRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.shipping.locations.states.edit', ['id' => $request['id'], 'lang' => $request['lang']]);
        } else {
            toastNotification('error', translate('Action failed'), 'Failed');
            return redirect()->back();
        }
    ...
    {
        return view('plugin/ecommerce::shipping.locations.cities.index')->with(
            [
    ...
    {
        return view('plugin/ecommerce::shipping.locations.cities.add_new')->with(
            [
    ...
    public function storeNewCity(CitiesRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.shipping.locations.cities.list');
        } else {
            toastNotification('error', translate('Action failed'), 'Failed');
            return redirect()->back();
        }
    ...
    {
        return view('plugin/ecommerce::shipping.locations.cities.edit')->with(
            [
                'states' => $this->location_repository->states([config('settings.general_status.active')]),
    ...
    public function updateCity(CitiesRequest $request)
    {
        ...
        if ($res == true) {
            ...
            return redirect()->route('plugin.ecommerce.shipping.locations.cities.edit', ['id' => $request['id'], 'lang' => $request['lang']]);
        } else {
            toastNotification('error', translate('Action failed'), 'Failed');
            return redirect()->back();
        }
