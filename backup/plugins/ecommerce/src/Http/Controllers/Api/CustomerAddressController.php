...
class CustomerAddressController extends Controller
{
    ...
    public function customerActiveAddress()
    {
        $addresses = $this->customer_repository->customerAllAddress(auth('jwt-customer')->user()->id, config('settings.general_status.active'));
        if ($addresses != NULL) {
            return  new CustomerAddressCollection($addresses);
        } else {
            return response()->json(
