        ...
        <div class="col-12 col-lg-10 m-auto">
            <div class="card mb-30">
                ...
                <div class="px-2 filter-area d-flex align-items-center">
                    <!--Filter area-->
                    <form method="get" action="{{ route('plugin.ecommerce.reports.products.wishlist') }}">
                    ...
                    @if (request()->has('search_key') || request()->has('category'))
                        <a class="btn long btn-danger" href="{{ route('plugin.ecommerce.reports.products.wishlist') }}">
