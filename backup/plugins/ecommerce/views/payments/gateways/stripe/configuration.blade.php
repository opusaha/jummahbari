    ...
    <div class="configuration">
        <form id="credential-form-{{ $method->id }}">
            ...
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <textarea name="stripe_instruction" class="theme-input-style" placeholder="Enter Instruction">{{ \Plugin\Ecommerce\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'stripe_instruction') }}</textarea>
                    <small class="text-muted"><i class="icofont-info-circle"></i>
                        {{ translate('Customer will see this instructions when paying with Stripe') }}</small>
                </div>
            </div>
            <div>
