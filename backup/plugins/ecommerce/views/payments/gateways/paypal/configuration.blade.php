    ...
    <div class="configuration">
        <form id="credential-form-{{ $method->id }}">
            ...
            <div class="form-group mb-20">
                ...
                <div class="input-option">
                    <textarea name="paypal_instruction" class="theme-input-style" placeholder="Enter Payment Instructions">{{ \Plugin\Ecommerce\Repositories\PaymentMethodRepository::configKeyValue($method->id, 'paypal_instruction') }}</textarea>
                </div>
                <small class="text-muted"><i class="icofont-info-circle"></i>
                    {{ translate('Customer will see this instructions when paying with Paypal') }}</small>
            </div>
            <div>
