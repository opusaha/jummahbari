                                                        ...
                                                        @php
                                                            ...
                                                            foreach ($variant_array as $com_key => $variant) {
                                                                ...
                                                                if ($variant_com_array[0] === 'color') {
                                                                    ...
                                                                    $option_name = \Plugin\Ecommerce\Models\ProductAttribute::find(
                                                                        $variant_com_array[0],
                                                                    )->translation('name');
                                                                    $choice_name = \Plugin\Ecommerce\Models\AttributeValues::find(
                                                                        $variant_com_array[1],
                                                                    )->name;
                                                                }
...
@section('custom_scripts')
    ...
    <script>
        (function($) {
             ...
             * Get review details
             **/
            $(document).on('click', '.review-details', function(e) {
                e.preventDefault();
                let id = $(this).data('review');
