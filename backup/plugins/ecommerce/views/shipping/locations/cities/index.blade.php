        ...
        <div class="col-12">
            <div class="card mb-30">
                <div class="card-body border-bottom2 mb-20">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-wrap">
                            <a href="{{ route('plugin.ecommerce.shipping.locations.cities.add.new') }}"
                ...
                <div class="px-2 filter-area d-flex align-items-center">
                    <!--Filter area-->
                    <form method="get" action="{{ route('plugin.ecommerce.shipping.locations.cities.list') }}">
                    ...
                    @if (request()->has('search_key'))
                        <a class="btn long btn-danger"
                            href="{{ route('plugin.ecommerce.shipping.locations.cities.list') }}">
                                        ...
                                        <td>
                                            <div class="dropdown-button">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a
                                                        href="{{ route('plugin.ecommerce.shipping.locations.cities.edit', ['id' => $city->id, 'lang' => getDefaultLang()]) }}">
                                                        {{ translate('Edit') }}
                                                    </a>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.ecommerce.shipping.locations.cities.delete') }}">
                        @csrf
    ...
    <script>
        (function($) {
            ...
            $('.change-status').on('click', function(e) {
                ...
                $.post('{{ route('plugin.ecommerce.shipping.locations.cities.status.change') }}', {
                    _token: '{{ csrf_token() }}',
                    id: id
                }, function(data) {
                    location.reload();
            ...
            $('.fire-bulk-action').on('click', function(e) {
                ...
                if (action != 'null') {
                    ...
                    if (selected_items.length > 0) {
                        $.post('{{ route('plugin.ecommerce.shipping.locations.cities.bulk.action') }}', {
                            _token: '{{ csrf_token() }}',
