     ...
     (function($) {
         ...
         function getSearchedLocationsEdit(searchKey) {
             ...
             $.ajax({
                 ...
                 url: '{{ route('plugin.ecommerce.shipping.search.location.ul.list.edit') }}',
         ...
         function getEditZoneCountriesOptions() {
             ...
             $.ajax({
                 ...
                 url: '{{ route('plugin.ecommerce.shipping.location.ul.list.edit') }}',
                 success: function(response) {
                     if (response.success) {
                         $('.edit-location-options').append(response.list);
         ...
         $('.update-zone').click('on', function(e) {
             ...
             $.ajax({
                 ...
                 url: '{{ route('plugin.ecommerce.shipping.profile.zones.update') }}',
                 success: function(response) {
                     location.reload();
                 },
