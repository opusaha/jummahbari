 @foreach ($countries as $country)
     <li class="cl-item cl-item-open">
         ...
         <div class="cl-label-wrap">
             @if (\Plugin\Ecommerce\Repositories\ShippingRepository::countryInAnotherShippingRate($country->id))
         ...
         @if (count($states) > 0)
             <ul class="js-check-all-target js-check-all" data-check-all="country-{{ $country->id }}">
                 @foreach ($states as $state)
                     ...
                     <li class="cl-item">
                         <div class="cl-label-wrap">
                             @if (\Plugin\Ecommerce\Repositories\ShippingRepository::stateInAnotherShippingRate($state->id))
                         ...
                         @if (count($cities) > 0)
                             <ul class="js-check-all-target js-check-all" data-check-all="state-{{ $state->id }}">
                                 @foreach ($cities as $city)
                                     <li class="cl-item">
                                         <div class="cl-label-wrap">
                                             @if (\Plugin\Ecommerce\Repositories\ShippingRepository::cityInAnotherShippingRate($city->id))
