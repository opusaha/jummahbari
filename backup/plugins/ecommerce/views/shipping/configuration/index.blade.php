                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="custom-radio mr-3">
                                    <input type="radio" id="locationBased" name="shipping_option"
                                        value="{{ config('ecommerce.shipping_cost_options.location_wise_rate') }}"
                                        @checked(SettingsRepository::getEcommerceSetting('shipping_option') ==
                                                config('ecommerce.shipping_cost_options.location_wise_rate'))>
    ...
    <div id="delete-rate-modal" class="delete-rate-modal modal fade show" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="mt-1">{{ translate('Are you sure to delete this') }}?</p>
                    <form method="POST" action="{{ route('plugin.ecommerce.shipping.location.based.rate.delete') }}">
                        @csrf
        ...
        (function($) {
            ...
            $('#new-shipping-rate-form').on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.shipping.location.based.rate.store') }}',
                    success: function(response) {
                        location.reload();
                    },
                    error: function(response) {
            ...
            $(document).on('submit', '#edit-shipping-rate-form', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.shipping.location.based.rate.update') }}',
                    success: function(response) {
                        location.reload();
                    },
                    error: function(response) {
