             ...
             <div class="col-12">
                 <select class="theme-input-style" name="discount_amount_type">
                     <option value="{{ config('ecommerce.amount_type.flat') }}"
                         @if ($product_details->discount_type == config('ecommerce.amount_type.flat')) selected @endif>
 ...
 @if ($action == 'edit_price')
     <form id="edit-price-form">
         ...
         <div
             class="single-product-price {{ $product_details->has_variant == config('ecommerce.product_variant.single') ? '' : 'd-none' }}">
             <div class="form-row mb-20">
                 <div class="col-12">
     ...
     (function($) {
         ...
         $('.edit-discount-btn').on('click', function(e) {
             ...
             $.ajax({
                 ...
                 url: '{{ route('plugin.ecommerce.product.quick.update.discount') }}',
         ...
         $('.edit-price-btn').on('click', function(e) {
             ...
             $.ajax({
                 ...
                 url: '{{ route('plugin.ecommerce.product.quick.update.price') }}',
                 success: function(data) {
                     if (data.success) {
                         toastr.success(
         ...
         $('.edit-stock-btn').on('click', function(e) {
             ...
             $.ajax({
                 ...
                 url: '{{ route('plugin.ecommerce.product.quick.update.stock') }}',
                 success: function(data) {
                     if (data.success) {
                         toastr.success(
