                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset(getFilePath($product->thumbnail_image, true)) }}"
                                                class="img-100-auto" alt="{{ $product->name }}">
                                        </td>
                                        <td>
                                                        ...
                                                        @php
                                                            ...
                                                            foreach ($variant_array as $com_key => $variant) {
                                                                ...
                                                                if ($variant_com_array[0] === 'color') {
                                                                    ...
                                                                    $choice_name = \Plugin\Ecommerce\Models\Colors::find(
                                                                        $variant_com_array[1],
                                                                    )->translation('name');
                                                                } else {
                                                                    $option_property = \Plugin\Ecommerce\Models\ProductAttribute::select(
                                                                        ['id', 'name'],
                                                                    ...
                                                                    $option_name =
                                                                        $option_property != null
                                                                            ...
                                                                            : '';
                                                                    $choice_property = \Plugin\Ecommerce\Models\AttributeValues::select(
                                                                        ['id', 'name'],
