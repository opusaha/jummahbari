                  ...
                  @foreach ($combinations as $key => $combination)
                      @php
                          ...
                          foreach ($combination as $option_id => $choice_id) {
                              if ($option_id != 'color') {
                                  $option_name = \Plugin\Ecommerce\Models\ProductAttribute::find($option_id)->translation('name');
                                  $choice_name = \Plugin\Ecommerce\Models\AttributeValues::find($choice_id)->name;
                              } else {
                                  $option_name = translate('Color');
                                  $choice_name = \Plugin\Ecommerce\Models\Colors::find($choice_id)->translation('name');
                              }
