                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group d-flex">
                                                <select class="form-control choice-options-select"
                                                    ...
                                                    @php
                                                        $attribute_values = \Plugin\Ecommerce\Models\AttributeValues::where(
                                                            'attribute_id',
                                                            $choice->choice_id,
                                                        )
                                                            ->where('status', config('settings.general_status.active'))
                                            ...
                                            @php
                                                ...
                                                foreach ($variant_array as $com_key => $variant) {
                                                    ...
                                                    if ($variant_com_array[0] === 'color') {
                                                        ...
                                                        //Color Choice Option
                                                        $choice_details = \Plugin\Ecommerce\Models\Colors::find(
                                                            $variant_com_array[1],
                                                        );
                                                        ...
                                                        //Option
                                                        $option_details = $attributes
                                                            ->where('id', $variant_com_array[0])
                                                            ->first();
                                                        if ($option_details != null) {
                                                            $option_name = $option_details->translation(
                                                                'name',
                                                                getLocale(),
                                                            );
                                                        }
                                                        //Choice
                                                        $choice_details = \Plugin\Ecommerce\Models\AttributeValues::find(
                                                            $variant_com_array[1],
                                                        );
                                                        if ($choice_details != null) {
                    ...
                    @if (count($product_details->color_choices) > 0)
                        <div class="card-body">
                            @foreach ($product_details->color_choices as $key => $color)
                                @php
                                    $color_name = \Plugin\Ecommerce\Models\Colors::find($color->color_id)->translation(
                                        'name',
                                    );
                                    $color_images = \Plugin\Ecommerce\Models\ProductColorVariantImages::where(
                                        'product_id',
                                        $product_details->id,
                                    )
            ...
            <div class="card mb-30 @if (!empty($lang) && $lang != getdefaultlang()) area-disabled @endif">
                ...
                <div class="card-body">
                    ...
                    <div
                        ...
                        <div class="col-sm-9">
                            @php
                                $gallary_images = \Plugin\Ecommerce\Models\ProductGalleryImages::where(
                                    'product_id',
                                    $product_details->id,
                                )
                                    ->pluck('image_id')
            ...
            <div class="card mb-30">
                ...
                <div class="card-body">
                    ...
                    @if (getEcommerceSetting('shipping_option') != null &&
                        ...
                        <div class="profile-wise-shipping-cost">
                    ...
                    @if (getEcommerceSetting('shipping_option') == null ||
                        ...
                        <div class="profile-wise-shipping-cost">
                            <p class="font-13 mb-0">
                                {{ translate('Flat Rate Shipping Cost is Activated') }}
                                <a href="{{ route('plugin.ecommerce.shipping.configuration') }}" class="btn-link">
                    ...
                    @if (getEcommerceSetting('shipping_option') == null ||
                            getEcommerceSetting('shipping_option') == config('ecommerce.shipping_cost_options.location_wise_rate'))
                        <div class="profile-wise-shipping-cost">
                            <p class="font-13 mb-0">
                                {{ translate('Location Based Shipping Cost is Activated') }}
                                <a href="{{ route('plugin.ecommerce.shipping.configuration') }}" class="btn-link">
                                    {{ translate('Configure Shipping & Delivery') }}
                                </a>
                            </p>
                    ...
                    @endif
                    <!--End Location Based Shipping Cost-->
                </div>
            </div>
