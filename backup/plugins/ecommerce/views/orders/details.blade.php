                            ...
                            <div class="shipping-info d-flex">
                                ...
                                <span>(
                                    ...
                                    @if ($product->shipping_rate_info->shipping_medium != null)
                                        ...
                                        <span>{{ $product->shipping_rate_info->shipped_by() }}</span>
                                    @endif
                                    )
                                </span>
                            </div>
                        ...
                        <table class="text-right shop_table style-two">
                            <tbody>
                                ...
                                <tr class="cart-tax border-1">
                                    <td>{{ translate('Coupon Discount') }}
                                        @if ($order_details->use_coupon != null)
                                            <span
                                                class="font-weight-bold text-primary">({{ $order_details->use_coupon->code }})</span>
                                        @endif
                                    </td>
                                    <td>
