...
@section('main_content')
                            ...
                            @if ($orders->count() > 0)
                                @foreach ($orders as $key => $order)
                                    <tr>
                                        ...
                                        <td>{{ $order->created_at = Carbon\Carbon::parse($order->created_at)->format('d M Y h:i A') }}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="dropdown-button">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a href="#" class="order-delete-btn"
                                                        data-order="{{ $order->id }}">{{ translate('Delete') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <div id="order-delete-modal" class="order-delete-modal modal fade show" aria-modal="true">
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body text-center">
                    <p class="mt-1">{{ translate('Are you sure to delete  this order') }}?</p>
                    <form method="POST" action="{{ route('plugin.ecommerce.orders.delete') }}">
                        @csrf
