<div class="card">
    <div class="card-body">
        ...
        <div class="form-row mb-20">
            ...
            <div class="col-sm-1">
                <label class="switch glow primary medium">
                    <input type="checkbox" name="customer_email_verification" @checked(getEcommerceSetting('customer_email_verification') == config('settings.general_status.active'))>
                    <span class="control"></span>
                </label>
            </div>
            <div class="col-sm-5">
                <p class="mt-0 font-13">
                    ...
                    <br>
                    <a href="https://documentation.fashionlooks.themelooks.us/blog/cron-job-setup" target="_blank"
