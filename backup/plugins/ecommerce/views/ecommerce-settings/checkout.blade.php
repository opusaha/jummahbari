 <div class="card">
     <div class="card-body">
         ...
         <div class="form-row mb-20 {{ isActivePlugin('pickuppoint') ? '' : 'area-disabled mb-0' }}">
             ...
             <div class="col-sm-1">
                 <label class="switch glow primary medium">
                     <input type="checkbox" name="enable_pickup_point_in_checkout" @checked(getEcommerceSetting('enable_pickup_point_in_checkout') == config('settings.general_status.active'))>
                     <span class="control"></span>
                 </label>
             </div>
         ...
         <div class="form-row mb-20">
             ...
             <div class="col-sm-6">
                 <label class="switch glow primary medium">
                     <input type="checkbox" name="enable_minimum_order_amount" class="enable-minumun-order-amount"
                         @checked(getEcommerceSetting('enable_minimum_order_amount') == config('settings.general_status.active'))>
                     <span class="control"></span>
                 </label>
             </div>
         </div>
         <div
             class="form-row mb-20 minimum-order-amount {{ getEcommerceSetting('enable_minimum_order_amount') == config('settings.general_status.active') ? '' : 'd-none' }}">
         ...
         <!--End mi order amount-->
         <h4 class="mb-3">{{ translate('Shipping Address Form') }}</h4>
         <div class="form-row mb-20">
             <div class="col-sm-4">
             ...
             <div class="col-sm-4 align-items-center d-flex gap-10">
                 ...
                 <label class="font-14 bold black">{{ translate('Enable/ Disable') }}</label>
             </div>
             <div class="col-sm-4 align-items-center d-flex gap-10">
                 <label class="switch glow primary medium">
                 ...
                 <label class="font-14 bold black">{{ translate('Required/ Optional') }}</label>
             </div>
         </div>
         ...
         <div class="form-row mb-20">
             <div class="col-sm-6">
                 <label class="font-14 bold black ">
                     {{ translate('Enable Country, State and city dropdown in checkout') }}
                 </label>
             </div>
             <div class="col-sm-1">
                 <label class="switch glow primary medium">
                     <input type="checkbox" name="enable_country_state_city_in_checkout"
                         @checked(getEcommerceSetting('enable_country_state_city_in_checkout') == config('settings.general_status.active'))>
                     <span class="control"></span>
                 </label>
             </div>
             <div class="col-sm-5">
                 <p class="mt-0 font-13">
                     {{ translate('If you enable Country, State and city dropdown in checkout then you must select Flat rate shipping cost or Product wise shipping cost. Based on shipping profile not working') }}
