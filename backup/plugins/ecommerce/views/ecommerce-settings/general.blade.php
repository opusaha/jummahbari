<div class="card">
    <div class="card-body">
        ...
        <div class="form-row mb-20">
            <div class="col-sm-4">
                <label class="font-14 bold black">{{ translate('Privacy Policy') }}
                </label>
            </div>
            <div class="col-sm-4">
                <select class="form-control" name="privacy_policy_page">
                    <option value="">{{ translate('Select a page') }}</option>
                    @foreach ($all_pages as $page)
                        <option value="{{ $page->id }}" @selected(getEcommerceSetting('privacy_policy_page') == $page->id)>
                            {{ $page->title }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="form-row mb-20">
            <div class="col-sm-4">
                <label class="font-14 bold black">{{ translate('Return Policy Page') }}
                </label>
            </div>
            <div class="col-sm-4">
                <select class="form-control" name="return_policy_page">
                    <option value="">{{ translate('Select a page') }}</option>
                    @foreach ($all_pages as $page)
                        <option value="{{ $page->id }}" @selected(getEcommerceSetting('return_policy_page') == $page->id)>
                            {{ $page->title }}
                        </option>
                    @endforeach
                </select>
