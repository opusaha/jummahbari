    ...
    <div class="card">
        <div class="card-body">
            <div class="form-row mb-20">
                ...
                <div class="col-sm-9">
                    <input type="text" name="shop_name" class="theme-input-style shop-name"
                        placeholder="{{ translate('Enter Shop Name') }}" value="{{ $shop?->shop_name }}" required>
                </div>
            </div>
            <div class="form-row mb-20">
                <div class="col-sm-3">
                ...
                <div class="col-sm-9">
                    <a href="{{ url('/shop') }}/{{ $shop?->shop_slug }}" target="_blank">{{ url('') }}/shop/<span
                            id="permalink">{{ $shop?->shop_slug }}</span>
                        <span class="btn custom-btn ml-1 permalink-edit-btn">
                            {{ translate('Edit') }}
                        </span>
                    </a>
                    <input type="hidden" name="shop_slug" id="permalink_input_field" value="{{ $shop?->shop_slug }}"
                        required>
            ...
            <div class="form-row mb-20">
                ...
                <div class="col-sm-9">
                    <input type="text" name="shop_phone" class="theme-input-style"
                        placeholder="{{ translate('Enter Shop Phone') }}" value="{{ $shop?->shop_phone }}" required>
                </div>
            </div>
            ...
            <div class="form-row mb-20">
                ...
                <div class="col-sm-9">
                    <input type="text" name="shop_address" class="theme-input-style"
                        placeholder="{{ translate('Enter Shop Address') }}" value="{{ $shop?->shop_address }}">
                </div>
            </div>
            ...
            <div class="form-row mb-20">
                ...
                <div class="col-sm-9">
                    <input type="text" name="shop_meta_title" class="theme-input-style"
                        placeholder="{{ translate('Enter Meta Title') }}" value="{{ $shop?->meta_title }}" required>
                </div>
            </div>
            ...
            <div class="form-row mb-20">
                ...
                <div class="col-sm-9">
                    <textarea name="shop_meta_description" class="theme-input-style">{{ $shop?->meta_description }}</textarea>
                </div>
            </div>
        </div>
    </div>
