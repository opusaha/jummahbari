    ...
    <div class="card-body">
        ...
        <div
            ...
            <div class="form-row mb-20">
                ...
                <div class="col-sm-6">
                    <label class="switch glow primary medium">
                        <input type="checkbox" name="only_verified_customer_left_review"
                            @if (getEcommerceSetting('only_verified_customer_left_review') == config('settings.general_status.active')) checked @endif>
                        <span class="control"></span>
                    </label>
                </div>
            </div>
