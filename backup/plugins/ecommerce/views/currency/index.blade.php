                ...
                <div class="card-header bg-white border-bottom2">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-wrap">
                            <a href="{{ route('plugin.ecommerce.ecommerce.add.currency') }}"
                                    ...
                                    <td>
                                        <div class="dropdown-button">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a
                                                    href="{{ route('plugin.ecommerce.ecommerce.edit.currency', $currency->id) }}">Edit</a>
                                                <a href="#"
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <form method="POST" action="{{ route('plugin.ecommerce.ecommerce.currency.delete') }}">
                            @csrf
    ...
    <script type="application/javascript">
       (function($) {
        ...
        function updateCurrencyStatus(currency_id) {
            ...
            $.post("{{ route('plugin.ecommerce.ecommerce.update.currency.status') }}", {
                    _token: '{{ csrf_token() }}',
                    id: currency_id,
                    status: status
                },
