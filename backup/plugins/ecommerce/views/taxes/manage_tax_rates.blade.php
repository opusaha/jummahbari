            ...
            <div class="card mb-30">
                ...
                <div class="card-body">
                    <div class="px-2 filter-area d-flex align-items-center">
                        <!--Filter area-->
                        <form method="get"
                            action="{{ route('plugin.ecommerce.ecommerce.settings.taxes.manage.rates', ['id' => $profile->id]) }}">
        ...
        (function($) {
            ...
            $('.create-tax-rates-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.ecommerce.settings.taxes.store.rates') }}',
                    success: function(response) {
                        if (response.success) {
                ...
                if (action != 'null') {
                    ...
                    if (selected_items.length > 0) {
                        ...
                        if (action === 'delete_all') {
                            $.post('{{ route('plugin.ecommerce.ecommerce.settings.taxes.rates.bulk.action') }}', {
                                _token: '{{ csrf_token() }}',
            ...
            $('.update-tax-rate-value-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.ecommerce.settings.taxes.update.rates.value') }}',
                    success: function(response) {
                        if (response.success) {
            ...
            $('.update-tax-post-code-value-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.ecommerce.settings.taxes.update.rates.post.code') }}',
                    success: function(response) {
                        if (response.success) {
            ...
            $('.update-tax-rate-name-btn').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('plugin.ecommerce.ecommerce.settings.taxes.update.rates.name') }}',
                    success: function(response) {
                        if (response.success) {
