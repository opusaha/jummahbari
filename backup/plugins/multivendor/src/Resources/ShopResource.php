...
class ShopResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'name' => $this->shop_name,
            'slug' => $this->shop_slug,
            'logo' => getFilePath($this->logo, true),
            'shop_banner' => $this->shop_banner != null ? getFilePath($this->shop_banner, false) : getFilePath(get_setting('shop_default_bg_image'), false),
