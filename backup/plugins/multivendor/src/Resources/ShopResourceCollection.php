        ...
        return [
            'data' => $this->collection->map(function ($data) {
                return [
                    ...
                    'logo' => asset(getFilePath($data->logo, true)),
                    'shop_banner' => $data->shop_banner != null ? asset(getFilePath($data->shop_banner, true)) : asset(getFilePath(get_setting('shop_default_bg_image'), false)),
                ];
            })
        ];
    }
