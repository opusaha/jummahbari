...
class EarningController extends Controller
{
    ...
    public function payoutRequestsSend(SellerPayoutFormRequest $request)
    {
        ...
        if (get_setting('seller_min_withdrawal_amount') != null && $request['amount'] < get_setting('seller_min_withdrawal_amount')) {
            throw ValidationException::withMessages(
                [
                    'amount' => [translate('Minimum withdrawable amount is') . ' ' . currencyExchange(get_setting('seller_min_withdrawal_amount'))]
                ]
            );
        }
