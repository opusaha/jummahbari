                ...
                <div class="card-body">
                    <div>
                        <form action="{{ route('plugin.multivendor.admin.seller.settings.update') }}" method="POST">
                            ...
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-8">
                                    <input type="number" name="seller_default_commission" class="theme-input-style"
                                        value="{{ get_setting('seller_default_commission') }}" placeholder="0.00">
                                ...
                                <div class="col-md-8">
                                    <label class="switch glow primary medium">
                                        <input type="checkbox" name="category_wise_seller_commission"
                                            ...
                                            {{ get_setting('category_wise_seller_commission') == config('settings.general_status.active') ? 'checked' : '' }}>
                            ...
                            <div
                                class="mb-20 categories-wise-commission-options {{ get_setting('category_wise_seller_commission') == config('settings.general_status.active') ? '' : 'd-none' }}">
                                @php
                                    $position = 0;
                                @endphp
                            ...
                            <div
                                class="form-row mb-20 categories-wise-commission-options-btn {{ get_setting('category_wise_seller_commission') == config('settings.general_status.active') ? '' : 'd-none' }}">
                                <button type="button"
                                ...
                                <div class="col-md-8">
                                    <label class="switch glow primary medium">
                                        <input type="checkbox" name="seller_auto_verification"
                                            {{ get_setting('seller_auto_verification') == config('settings.general_status.active') ? 'checked' : '' }}>
                                        <span class="control"></span>
                                    </label>
                                ...
                                <div class="col-md-8">
                                    <label class="switch glow primary medium">
                                        <input type="checkbox" name="product_auto_approve"
                                            {{ get_setting('product_auto_approve') == config('settings.general_status.active') ? 'checked' : '' }}>
                                        <span class="control"></span>
                                    </label>
                            ...
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-8">
                                    <input type="number" name="seller_min_withdrawal_amount" class="theme-input-style"
                                        value="{{ get_setting('seller_min_withdrawal_amount') }}" placeholder="0.00">
                            ...
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-8">
                                    @include('core::base.includes.media.media_input', [
                                        ...
                                        'data' => get_setting('shop_default_bg_image'),
                                    ])
