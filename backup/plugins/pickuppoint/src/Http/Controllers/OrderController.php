...
class OrderController extends Controller
{
    ...
    public function orderList(Request $request)
    {
        ...
        $orders = $this->order_repository->orderList($request, config('ecommerce.order_type.local_pickup'));
        $order_counter = $this->order_repository->orderCounter(config('ecommerce.order_type.local_pickup'));
        return view('plugin/pickuppoint::pages.orders.orders')->with(
            [
                'orders' => $orders,
