...
class ThemeOptionRepository
{
    ...
    public function saveThemeOption($request)
    {
        ...
        if ($option_name == 'subscribe') {
            setEnv('NEWSLETTER_API_KEY', str_replace(' ', '', $request->mailchimp_api_key));
            setEnv('NEWSLETTER_LIST_ID', str_replace(' ', '', $request->mailchimp_list_id));
        }
        ...
        switch ($option_name) {
            ...
            case 'custom_css':
                ...
                $path = base_path('/themes/fashion-theme/public/css/custom_css.css');
                if (file_exists($path)) {
                    unlink($path);
                }
    ...
    public function setBlogStyle()
    {
        ...
        $path = base_path('themes/fashion-theme/public/css/blog.css');
        setFolderPermissions($path);
    ...
    public function setSidebarOptionStyle()
    {
        ...
        $path = base_path('themes/fashion-theme/public/css/sidebar_options.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function set404PageStyle()
    {
        ...
        $path = base_path('themes/fashion-theme/public/css/page_404.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
        ...
        if (isset($style['custom_footer']) && $style['custom_footer'] == 1) {
            foreach ($updatedStyle as $key => $value) {
                if ($key == 'custom_footer_padding_top' && $value != "") {
                    $themeOption['.custom-footer']['padding-top'] = $value . "!important;";
                }
                if ($key == 'custom_footer_padding_bottom' && $value != "") {
                    $themeOption['.custom-footer']['padding-bottom'] = $value . "!important;";
                }
                if ($key == 'footer_background_color' && $value != "") {
                    $themeOption['.custom-footer.footer-middle']['background-color'] = $value . "!important;";
                    $themeOption['.custom-footer.footer-bottom']['background-color'] = $value . "!important;";
                }
                if ($key == 'footer_text_color' && $value != "") {
                    $themeOption['.custom-footer']['color'] = $value . "!important;";
                    $themeOption['.custom-footer h2']['color'] = $value . "!important;";
                    $themeOption['.custom-footer h3']['color'] = $value . "!important;";
                    $themeOption['.custom-footer h5']['color'] = $value . "!important;";
                    $themeOption['.custom-footer p']['color'] = $value . "!important;";
                }
                if ($key == 'footer_anchor_color' && $value != "") {
                    $themeOption['.custom-footer a']['color'] = $value . "!important;";
                }
                if ($key == 'footer_anchor_hover_color' && $value != "") {
                    $themeOption['.custom-footer a:hover']['color'] = $value . "!important;";
                }
            }
            $styleProperties = makeCssProperties($themeOption);
        }
        $path = base_path('themes/fashion-theme/public/css/footer.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setBackToTopStyle()
    {
        ...
        $path = base_path('themes/fashion-theme/public/css/back_to_top.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    /**
    ...
    public function setSocialIconStyle()
    {
        ...
        $path = base_path('themes/fashion-theme/public/css/social_icon.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setHeaderOptionsStyle()
    {
        ...
        if (isset($style['custom_header']) && $style['custom_header'] == 1) {
            foreach ($style as $key => $value) {
                ...
                if ($key == 'header_middle_text_color' && $value != "") {
                    ...
                    $themeOption['.custom-header-mid .search-form .input-group']['border'] = "1px solid" . $value . " !important;";
                }
        ...
        $path = base_path('themes/fashion-theme/public/css/header.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setHeaderLogosStyle()
    {
        ...
        $path = base_path('themes/fashion-theme/public/css/header_logo.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setHeaderMenuStyle()
    {
        ...
        $path = base_path('themes/fashion-theme/public/css/menu.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function setNewsletterStyle()
    {
        ...
        $path = base_path('themes/fashion-theme/public/css/subscribe.css');
        setFolderPermissions($path);
        file_put_contents($path, $styleProperties);
    }
    ...
    public function resetThemeOption($request)
    {
        ...
        if ($request->submitType == 'reset_section') {
            $path = base_path('themes/fashion-theme/public/css/' . $request->option_name . '.css');
            if (file_exists($path)) {
                unlink($path);
            }
            fopen($path, 'w');
        ...
        if ($request->submitType == 'reset_all') {
            for ($i = 0; $i < sizeof($themeOptionCssFile); $i++) {
                $path = base_path('themes/fashion-theme/public/css/' . $themeOptionCssFile[$i] . '.css');
                if (file_exists($path)) {
                    unlink($path);
                }
                fopen($path, 'w');
    ...
    {
        $active_theme = getActiveTheme();
        $location = 'themes/fashion-theme/public/';
