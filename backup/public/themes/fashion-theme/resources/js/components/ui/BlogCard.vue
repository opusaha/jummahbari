<template>
  <div class="blog-card d-inline-flex flex-column">
    <!-- Image -->
    <a class="blog-card-image d-block" :href="`/blog/${blog.permalink}`" v-if="blog.image != null">
      <v-lazy-image :src="blog.image" :alt="blog.title" />
    </a>
    <!-- End Image -->

    <!-- Content -->
    <div class="style--two blog-card-content d-flex flex-column align-items-start" v-if="styleTwo">
