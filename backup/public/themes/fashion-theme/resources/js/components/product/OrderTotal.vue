  ...
  <div class="order-details">
    <div v-if="coupon" class="coupon">
      <div class="form-group">
        <input class="form-control me-1" type="text" v-bind:placeholder="$t('Your Coupon')" />
      ...
      <table class="shop_table w-100">
        <tbody>
          <tr class="cart-subtotal">
            <td>{{ $t("Subtotal") }}</td>
            <td>
              <span class="price-amount amount"><bdi><span class="price-currency-symbol"></span>{{ subtotal
              }}</bdi></span>
            </td>
          </tr>
          ...
          <tr class="order-savings" v-if="couponDiscount">
            ...
            <td>
              <span class="price-amount amount c1">
                <bdi><span class="price-currency-symbol">-</span>{{ couponDiscount }}</bdi>
              </span>
            </td>
          </tr>
          ...
          <tr class="order-total">
            ...
            <td>
              <span class="price-amount amount c1"><bdi><span class="price-currency-symbol"></span>{{
                totalPrice }}</bdi></span>
            </td>
          </tr>
        </tbody>
