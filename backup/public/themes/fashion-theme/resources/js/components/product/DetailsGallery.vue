<template>
  <div class="product-image-gallery py-20 pl-20">
    ...
    <div class="carousel-wrapper">
      <swiper :style="{
        ...
        <swiper-slide v-for="(image, imageIndex) in galleryImages" :key="imageIndex" class="gallery-image">
          ...
          ">
            <img src="/public/web-assets/frontend/themes/fashion-theme/assets/img/play-big.png"
              class="play-icon gallery-preview-panel__video-player" alt="video" />
          </div>
          <!--End Video thumbnail-->
        </swiper-slide>
      </swiper>
      <swiper @swiper="setThumbsSwiper" :spaceBetween="10" :slidesPerView="5" :freeMode="true"
        ...
        <swiper-slide v-for="(image, imageIndex) in galleryImages" :key="imageIndex" class="gallery-image">
          ...
          <div class="item-gallery__image-wrapper" v-else>
            <img class="item-gallery__video-icon"
