          ...
          <div :class="blogsListLayoutClass">
            <template v-if="!blogs_loading">
              <div class="row mobile-gap-10">
                <div v-for="(blog, index) in blogs" :key="`blog-${index}`" :class="[
                ...
                <div class="col-md-12">
                  <ul class="tl-pagination custom-pagination">
                    ...
                    <template v-if="currentPage == 1">
                      <li>
                        <a href="#" @click="paginate(currentPage)" class="active">{{ currentPage }}</a>
                      </li>
                      <li v-if="endingPage > 1">
                        <a href="#" @click="paginate(2)">2</a>
                      </li>
                      <li v-if="endingPage > 2">
                        <a href="#" @click="paginate(3)">3</a>
                      </li>
                    </template>

                    <template v-else-if="currentPage == endingPage">
                      <li v-if="endingPage > 1">
                        <a href="#" @click="paginate(1)">1</a>
                      </li>
                      <li v-if="endingPage > 2">
                        <a href="#" @click="paginate(2)">2</a>
                      </li>
                    ...
                    <template v-else>
                      <li v-if="endingPage > 1">
                        <a href="#" @click="paginate(currentPage - 1)">{{ currentPage - 1 }}</a>
                      </li>
                      <li>
                        <a href="#" @click="paginate(currentPage)" class="active">{{ currentPage }}</a>
                      </li>
            ...
            <div class="row mobile-gap-10" v-if="blogs_loading">
              <div class="col-lg-4 col-6" v-for="(item, index) in blogsSkeletons" :key="index">
                <skeleton :height="item.height" class="w-100 mb-10"> </skeleton>
              </div>
            </div>
          </div>
          <div class="col-lg-3" v-if="blogOptionStyle.blog_layout != 'full_layout'">
