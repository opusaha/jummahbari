          ...
          <div class="col-12 mb-3" v-if="tableData.length > 0">
            <div class="table-responsive">
              <CTable class="style1 mb-0" :class="tableData.length == 1 ? 't-mh-160' : ''">
                ...
                <CTableBody>
                  <CTableRow v-for="(item, index) in tableData" :key="item.id">
                    ...
                    <CTableDataCell>
                      <button type="button" class="status-btn badge" :class="item.status">
                        {{ item.status }}
                      </button>
                      <p v-if="item.default_shipping == 1" class="text-info mb-0">
                        {{ $t("Default Shipping") }}
                      </p>
                      <p v-if="item.default_billing == 1" class="text-info mb-0">
                        {{ $t("Default Billing") }}
                      </p>
                    </CTableDataCell>
                    <CTableDataCell>
                      <CDropdown>
                        ...
                        <CDropdownMenu>
                          <CDropdownItem href="#" @click="EditAddress(item.id)">{{ $t("Edit") }}</CDropdownItem>
                        </CDropdownMenu>
                      </CDropdown>
                    </CTableDataCell>
                  </CTableRow>
      ...
      <CModalBody>
        ...
        <div class="row mb-20">
          <div class="form-group col-lg-6 mb-20"
            v-if="countries.length > 1 && configuration.enable_country_state_city_in_checkout == 1">
            <label class="font-weight-bold fz-12 mb-2">
          ...
          <div class="form-group col-lg-6 mb-20" v-if="configuration.enable_country_state_city_in_checkout == 1">
            <label class="font-weight-bold fz-12 mb-2">
          ...
          <!-- end city -->
          <!-- postal code -->
          <div v-if="configuration.enable_post_code_in_checkout == 1" :class="configuration.enable_country_state_city_in_checkout != 1
...
export default {
  ...
  mounted() {
    document.title = this.$t("Addresses") + " | " + this.$t("Dashboard");
