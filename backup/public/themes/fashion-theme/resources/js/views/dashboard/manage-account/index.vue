      ...
      <template v-if="!loading">
        ...
        <div class="bg-white p-20 mb-20">
          ...
          <div class="form-row align-items-center mb-20">
            ...
            <div class="col">
              <input name="name" type="text" placeholder="Type here" class="theme-input-style"
          ...
          <div class="form-row align-items-center mb-20">
            ...
            <div class="col">
              <div class="d-flex align-items-center flex-wrap" v-if="userData.image != null">
                <!-- Single Preview -->
                <div class="
                    single-preview-file
                    d-flex
                  ...
                  <button title="Remove" class="btn_circle" @click.prevent="removeOldImage">
                    <span class="material-icons">close</span>
                  </button>
                </div>
              </div>
              <base-file-input v-else id="customerImageInput" name="customerImageInput" single
                v-on:getFileInput="customerImage($event)" />
            </div>
          </div>
          <div class="form-row align-items-center mb-20">
            <button @click.prevent="updateProfile" class="btn btn_fill" :disabled="update_form_submitted">
        ...
        <div class="bg-white p-20 mb-20">
          ...
          <div class="form-row align-items-center">
            <a href="#" class="link-danger" v-if="password_reset_link_processing">
              <CSpinner component="span" size="sm" aria-hidden="true" />
              {{ $t("Please wait") }}...
            </a>
            <a href="#" class="link-info" v-else @click.prevent="customerForgotPassword">
              {{ $t("Generate password reset link") }}
            </a>
          </div>
        </div>
        <!--End Change Password-->
        ...
        <div class="bg-white p-20">
          ...
          <div class="form-row align-items-center">
            ...
            <a v-else href="#" class="link-info" @click.prevent="customerResetEmailLink">
              {{ $t("Generate email reset link") }}
            </a>
          </div>
        </div>
        <!--End Change Email-->
