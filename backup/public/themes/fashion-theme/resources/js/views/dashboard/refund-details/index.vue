        ...
        <div class="shadow-card mb-3 p-3">
          <div class="row">
            ...
            <div class="align-items-center col-12 col-lg-6 d-flex justify-content-lg-end">
              ...
              ">
                {{ $t("Total") }} :
                <the-currency :amount="orderDetails.total_amount"></the-currency>
              </h6>
              <h6 v-else>
                {{ $t("REFUND AMOUNT") }} :
                <the-currency :amount="orderDetails.refunded_amount"></the-currency>
              </h6>
            </div>
          </div>
        </div>
                  ...
                  <div class="col-md-12 mb-20">
                    <div class="order-info d-flex justify-content-between">
                      <div class="delivery-time">
                        <span>
                          {{ $t("Return") }}:
                          <span class="status-text text-capitalize" :class="orderDetails.return_status">{{
                      ...
                      <div class="delivery-time">
                        <span :class="orderDetails.payment_status">
                          {{ $t("Payment") }}:
                          <span class="status-text text-capitalize" :class="orderDetails.payment_status">
                  ...
                  <div class="col-12">
                    <div class="d-none d-lg-block">
                      ...
                      " :status="orderDetails.current_return_status"
                        :payment-status="orderDetails.current_payment_status" refund>
                      </order-steps>
                    ...
                    <order-tracking v-if="orderDetails.tracking_list.data.length > 0"
                      :items="orderDetails.tracking_list.data"></order-tracking>
                  </div>
                </div>
                        ...
                        <div class="row gy-10 align-items-center">
                          <div class="col-md-6">
                            <div class="align-items-center d-flex product-info">
                              <div class="image img70">
                                <router-link :to="`/products/${orderDetails.product_details.permalink}`">
                                  <img :src="orderDetails.product_details.image"
                          ...
                          <div class="col-md-6">
                            <div class="right-info d-flex justify-content-between">
                              ...
                              <div class="price">
                                {{ $t("Price") }}:
                                <the-currency :amount="orderDetails.product_details.price"></the-currency>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <tr v-if="orderDetails.attachments != null">
                      ...
                      <td>
                        <div class="attachments d-flex flex-wrap gap-1 ml-10">
                          <img :src="attachment" class="img-70" v-for="(
attachment, index
                            ) in orderDetails.attachments" :key="index" />
                        </div>
                      </td>
                    </tr>
                  </table>
