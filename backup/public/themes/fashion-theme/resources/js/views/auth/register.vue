        ...
        <div class="col-lg-5 mx-auto p-md-5 px-3 py-4 white-box">
              ...
              <div class="form-group mb-20">
                ...
                <div class="">
                  <input id="confirmPassword" type="password" v-bind:placeholder="$t('Confirm Password')"
                    class="theme-input-style" required v-model="customerData.password_confirmation" />
                </div>
              </div>
            </div>
          </div>
          <div class="row form-group align-items-center">
            <div class="col-12 d-flex align-items-center gap-2">
              ...
              <label class="checkmark" for="term">
                ...
                <router-link :to="`/page/${siteSettings.customer_term_condition_page_slug}`" target="_blank"
                  class="c1 mx-1">
          ...
          <div class="row">
            <div class="col-12 mt-3">
              <button @click.prevent="customerRegister" :disabled="formSubmitting" class="btn btn-fill">
  ...
  methods: {
    ...
    customerRegister() {
      ...
      if (this.term_condition_agreement) {
        ...
        this.term_condition_agreement_error = this.$t("Check Terms and Conditions");
        this.formSubmitting = false;
      }
    },
  },
