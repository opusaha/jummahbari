...
<div class="form-group row py-3 border-bottom align-items-center">
    <div class="col-xl-4 mb-3">
        <label for="header_bot_email_text" class="font-16 bold black">{{ translate('Header Bottom Contact Option') }}
        </label>
        <span class="d-block">{{ translate('Set Email or Phone') }}</span>
    </div>
    <div class="col-xl-2 offset-xl-1">
        <select name="header_bot_email_text_icon" id="header_bot_email_text_icon" class="form-control">
            <option value="email" @selected(isset($option_settings['header_bot_email_text_icon']) && $option_settings['header_bot_email_text_icon'] == 'email')>Email</option>
            <option value="phone" @selected(isset($option_settings['header_bot_email_text_icon']) && $option_settings['header_bot_email_text_icon'] == 'phone')>Phone</option>
        </select>
    </div>
    <div class="col-xl-4">
...
<div id="custom_header_switch_on_field">
    ...
    <div class="form-group row py-4 border-bottom">
        <div class="col-xl-4 mb-3">
            <label class="font-16 bold black">{{ translate('Header Middle Text Color') }}
            </label>
            <span class="d-block">{{ translate('Set Header Middle Text Color.') }}</span>
        </div>
        <div class="col-xl-6 offset-xl-1">
            <div class="row ml-2">
                <div class="color justify-content-between">
                    <input type="text" class="form-control" name="header_middle_text_color"
                        value="{{ isset($option_settings['header_middle_text_color']) ? $option_settings['header_middle_text_color'] : '' }}">

                    <input type="color" class="" id="header_middle_text_color"
                        value="{{ isset($option_settings['header_middle_text_color']) ? $option_settings['header_middle_text_color'] : '#fafafa' }}">

                    <label for="header_middle_text_color">{{ translate('Select Color') }}</label>
                </div>
                <div class="d-flex align-items-center">
                    <label class="custom-checkbox position-relative ml-2 mr-1">
