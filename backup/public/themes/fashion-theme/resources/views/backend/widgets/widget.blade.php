        ...
        <div class="col-md-5" id="widget-section">
            <div class="card p-0">
                <div class="card-header bg-white">
                    <a href="#allWidgets" class="align-items-center d-flex justify-content-between py-1"
                        data-toggle="collapse" aria-expanded="true" aria-controls="allWidgets">
                        <span class="black bold font-16">{{ translate('Elements') }}</span>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 mb-2 widget">
                                                <div class="widget-border">
                                                    <div
                                                        class="widget-info px-3 py-3 d-flex justify-content-between align-items-center">
                                                        <div class="info">
                                                            <input type="hidden" name="id"
                                                                value="{{ $widget->id }}">
                                                            <input type="hidden" name="sidebar_has_widget_id">
                                                            <p class="black bold font-14 mb-0">{{ $widget->widget_name }}
                                                            </p>
                                                            <small>{{ $widget->widget_short_desc }}</small>
                                                        </div>
                                                        <div>
        ...
        <div class="col-md-7 mt-3 mt-sm-0">
            <div class="card">
                <div class="card-header bg-white py-3">
                    <h4 class="card-title mb-1">{{ translate('Widgets Area') }}</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        @php
                            ...
                            <div class="col-md-6 mb-2 mb-sm-5">
                                <div class="card card-border">
                                    <div class="card-header py-3">
                                        <a href="#{{ $sidebar_attr_id }}" class="d-flex justify-content-between"
                                            data-toggle="collapse" aria-expanded="true"
                                            aria-controls="{{ $sidebar_attr_id }}">
