            ...
            <div class="col-4">
                <div class="input-group">
                    ...
                    <label for="full_layout">
                        <img src="{{ asset('/themes/fashion-theme/public/blog/images/layout/no-sideber.png') }}"
            ...
            <div class="col-4">
                <div class="input-group">
                    ...
                    <label for="left_sidebar_layout">
                        <img src="{{ asset('/themes/fashion-theme/public/blog/images/layout/left-sideber.png') }}"
            ...
            <div class="col-4">
                <div class="input-group">
                    ...
                    <label for="right_sidebar_layout">
                        <img src="{{ asset('/themes/fashion-theme/public/blog/images/layout/right-sideber.png') }}"
