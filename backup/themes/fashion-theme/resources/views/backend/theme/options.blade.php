...
@section('custom_css')
    ...
    <link rel="stylesheet" href="{{ asset('/themes/fashion-theme/public/blog/dist/css/fontawesome-iconpicker.min.css') }}">
    {{-- Jqueey UI CSS --}}
...
@section('custom_scripts')
    ...
    <script src="{{ asset('/themes/fashion-theme/public/blog/dist/js/fontawesome-iconpicker.min.js') }}"></script>
