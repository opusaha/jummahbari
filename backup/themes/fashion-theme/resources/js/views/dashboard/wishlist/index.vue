    ...
    <div class="customer-wishlist">
      ...
      <template v-if="!loading">
        <div class="pt-4" v-if="tableData.length > 0">
          <div class="row">
            <div class="col-12">
              <div class="shadow-card p-0">
                <div class="table-responsive">
                  <!-- Table -->
                  <CTable class="table style1 mb-0">
                    <CTableHead>
                      <CTableRow>
                    ...
                    <CTableBody>
                      <template v-for="(t_data, index) in tableData" :key="index">
                        <single-product :index="index" :item="t_data" wishlistStyle @remove-wishlist="removeWishlist" />
                      </template>
                    </CTableBody>
                  </CTable>
                </div>
