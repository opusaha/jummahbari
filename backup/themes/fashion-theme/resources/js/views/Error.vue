    ...
    <div class="custom-container2 my-5">
      ...
      >
        ...
        <div class="img-404 mt-30 mb-30" v-if="style404.custom_404 != 1">
          <img
            src="/public/web-assets/frontend/themes/fashion-theme/assets/img/404.png"
            alt="404 Image"
          />
        </div>
        ...
        >
          <strong class="pr-3">Back to Home</strong>
...
export default {
  ...
  methods: {
    ...
    ge404Style() {
      axios
        .get("/api/theme/fashion-theme/v1/get-404-page-style")
        .then((response) => {
