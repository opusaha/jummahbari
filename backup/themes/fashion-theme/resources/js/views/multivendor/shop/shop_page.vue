<template>
  <div class="shop-page" v-if="shop_found">
          ...
          <div class="col-12">
            <div class="align-items-center shop-header-inner">
              <div class="align-items-center d-flex gap-3 shop-brand">
                <img v-if="shopDetails.logo != null" :src="shopDetails.logo" :alt="shopDetails.name" class="img-70" />
              ...
              <div class="d-flex gap-4 right-side align-items-center flex-wrap">
                <div class="shop-statistic">
                  <div class="shop-rating" v-if="
                    reviewSummary != null &&
                    reviewSummary.positive_ratings > 0
                  ">
                    <strong class="c1">{{ reviewSummary.positive_ratings }}%</strong>
                ...
                <div class="mt-n1">
                  <router-link to="#" class="btn mt-1" @click.prevent="storeFollower()">
    ...
    <!--Shop Banner-->
    <div class="shop-banner" v-if="!loadingDetails && shopDetails.shop_banner != null">
        ...
        <div class="row align-items-center">
          <div class="col-12">
            <div class="shop-navigar">
              <nav>
                <a href="#" :class="{ active: homePage }" @click.prevent="goHome()">{{ $t("Home") }}</a>
                <a href="#" :class="{ active: allProductPage }" @click.prevent="goAllProducts()">
                  {{ $t("All Products") }}
                </a>
                <a href="#" :class="{ active: reviewPage }" @click.prevent="goReviews()">{{ $t("Reviews") }}</a>
              </nav>
            </div>
          </div>
        </div>
    ...
    <div class="pt-60 pb-60" v-if="homePage">
      <div class="custom-container2">
        <div class="row">
          <div class="col-12" v-if="!loadingProducts">
            ...
            <section class="pb-50" v-if="newItems.length">
              <div class="custom-container2">
                ...
                <swiper v-if="newItems.length" :slidesPerView="6" :modules="modules" :spaceBetween="24" :autoplay="{
                  delay: 2500,
                  ...
                  <swiper-slide v-for="(item, index) in newItems" :key="`slide-${index}`">
            ...
            <section class="pb-50" v-if="topSellingItems.length">
              <div class="custom-container2">
                ...
                <swiper v-if="topSellingItems.length" :slidesPerView="6" :modules="modules" :spaceBetween="24"
                  :autoplay="{
                    delay: 2500,
                    disableOnInteraction: false,
                    pauseOnMouseEnter: true,
                  ...
                  <swiper-slide v-for="(item, index) in topSellingItems" :key="`slide-${index}`">
                    <single-product :item="item" styleEight />
                  </swiper-slide>
                </swiper>
                <the-not-found title="No item found" v-else></the-not-found>
            ...
            <!-- Top Featured Items -->
            <section class="shop-featured-item list" v-if="featuredItems.length">
              <div class="custom-container2">
                <div class="row align-items-center">
                  <div class="col-md-6">
                ...
                <swiper v-if="featuredItems.length" :slidesPerView="6" :modules="modules" :spaceBetween="24" :autoplay="{
                  delay: 2500,
                  disableOnInteraction: false,
                  pauseOnMouseEnter: true,
                }" :loop="true" :pagination="{
                  ...
                  <swiper-slide v-for="(item, index) in featuredItems" :key="`slide-${index}`">
                    <single-product :item="item" styleEight />
                  </swiper-slide>
                </swiper>
                <the-not-found title="No item found" v-else></the-not-found>
          ...
          <div class="col-12" v-if="loadingProducts">
            <div class="row">
              <div class="col-2 p-1px" v-for="(item, index) in productSkeletons" :key="index">
      ...
      <div class="custom-container2">
        <div class="row">
          ...
          <div class="col-lg-9">
            ...
            <!--Product List-->
            <div class="row mobile-gap-10" v-if="!productsLoading && totalItems > 0">
              <div v-for="product in shopAllProducts" :key="product.id" class="col-lg-3 col-6">
            ...
            <div class="row align-items-center mt-10" v-if="!productsLoading">
              ...
              <div class="col-md-6 d-flex justify-content-center justify-content-md-end mt-3 mt-md-0">
                <!-- Pagination -->
                <v-pagination :options="paginationOptions" v-model="currentPage" :records="totalItems"
                  :per-page="perPage" @paginate="getShopAllProducts" />
                <!-- End Pagination -->
              </div>
            </div>
          </div>
                      ...
                      <div class="container-star">
                        <div class="star-rating">
                          <div class="product-rating-wrapper">
                            <i class="fs-34" :data-star="reviewSummary.avg_review"
                              :title="reviewSummary.avg_review"></i>
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  <the-not-found title="Shop not found" class="mt-3 py-2 text-center" v-else></the-not-found>
</template>
