        ...
        <div class="row">
          ...
          <div class="col-lg-9">
              ...
              <div class="col-12">
                <div class="mb-40 shadow-card">
                  <div class="row">
                    ...
                    <shop-sorting-option class="col-lg-6 order-0 order-lg-1 text-lg-right"
                      :data-loading="categoryLoading" :selected-item="sorting_by"
                      @sorting-items="sortingItems"></shop-sorting-option>
                  </div>
                  <!-- Brand Collapse Box -->
            ...
            <div class="row" v-if="shopLoading">
              <div class="col-12 col-lg-4" v-for="(item, index) in shopSkeletons" :key="index">
                <skeleton :height="item.height" class="w-100 mb-3"> </skeleton>
              </div>
            </div>
            <!--Shop List-->
            <div class="row" v-if="!shopLoading && totalItems > 0">
              <div class="col-12 col-lg-4 mb-20" v-for="(shop, index) in allShops" :key="index">
...
export default {
  ...
  mounted() {
    ...
    document.title = this.$t("All Stores");
  },
