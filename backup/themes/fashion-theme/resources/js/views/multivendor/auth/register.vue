        ...
        <div class="col-lg-5 mx-auto p-md-5 px-3 py-4 white-box">
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="form-group mb-20">
                ...
                <div class="">
                  <input type="text" v-bind:placeholder="$t('Name')" class="theme-input-style"
            ...
            <div class="col-lg-12">
              <div class="form-group mb-20">
                ...
                <div class="">
                  <input type="email" v-bind:placeholder="$t('Email')" class="theme-input-style" required
            ...
            <div class="col-lg-12">
              <div class="form-group mb-20">
                ...
                <div class="">
                  <input type="password" v-bind:placeholder="$t('Password')" class="theme-input-style" required
            ...
            <div class="col-lg-12">
              <div class="form-group mb-20">
                <label for="confirmPassword" class="font-weight-bold fz-12 mb-2">
                  {{ $t("Confirm Password") }}<span class="text-danger">*</span>
                </label>
                <div class="">
                  <input id="confirmPassword" type="password" v-bind:placeholder="$t('Confirm Password')"
                    class="theme-input-style" required v-model="sellerData.password_confirmation" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="form-group mb-20">
                ...
                <div class="">
                  <input type="text" v-bind:placeholder="$t('Shop Name')" class="theme-input-style"
                    v-model="sellerData.shop_name" @change="generateShopSlug('name')" />
                  <template v-if="errors.shop_name">
                    <p class="fz-12 text-danger mt-1" v-for="(error, index) in errors.shop_name" :key="index">
                      {{ error }}
                    </p>
                  </template>
                </div>
              ...
              <div class="form-group mb-20">
                ...
                <div class="">
                  <div class="align-items-center d-flex shop-url">
                    ...
                    <button class="btn btn-sm fz-14 ml-10" @click.prevent="
                      () => {
                        edit_slug = !edit_slug;
                      }
                    ">
                  ...
                  <div class="slug-input mt-2" v-if="edit_slug">
                    <input type="text" v-bind:placeholder="$t('Shop Url')" class="theme-input-style mb-2" required
                      v-model="sellerData.shop_url" @change="generateShopSlug('slug')" />
                    <button class="btn btn-sm fz-14" @click.prevent="generateShopSlug('slug')">
                      {{ $t("Save Change") }}
                    </button>
                  </div>

                  <template v-if="errors.shop_url">
                    <p class="fz-12 text-danger mt-1" v-for="(error, index) in errors.shop_url" :key="index">
                      {{ error }}
                    </p>
                  </template>
                </div>
            ...
            <div class="col-lg-12">
              <div class="form-group mb-20">
                ...
                <div class="">
                  <input type="text" v-bind:placeholder="$t('Shop Phone')" class="theme-input-style" required
                    v-model="sellerData.shop_phone" />
                  <template v-if="errors.shop_phone">
                    <p class="fz-12 text-danger mt-1" v-for="(error, index) in errors.shop_phone" :key="index">
                      {{ error }}
                    </p>
                  </template>
                </div>
          ...
          <div class="row form-group align-items-center">
            <div class="col-12 d-flex align-items-center gap-1">
              ...
              <label class="checkmark" for="term">
                ...
                <router-link :to="`/page/${siteSettings.seller_term_condition_page_slug}`" target="_blank"
                  class="c1 mx-1">
          ...
          <div class="row">
            <div class="col-12 mt-3">
              <button @click.prevent="sellerRegistration" :disabled="formSubmitting" class="btn btn-fill">
