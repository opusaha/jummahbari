<template>
  <div class="widget widget_best_seller">
    <div class="seller-info" v-if="shoSellerWidgetTitle">
      <div class="seller-banner" v-if="hasBanner">
        <router-link :to="`/shop/${shop.slug}`">
          <img :src="shop.shop_banner" :alt="shop.name" class="img-h-70 w-100" />
        </router-link>
      </div>
      <div class="best_seller">
        <div class="seller-feedback d-flex align-items-center">
          <div class="seller-badge rounded-circle border">
            <router-link :to="`/shop/${shop.slug}`">
              <img :src="shop.logo" :alt="shop.name" class="img-70 rounded-circle" />
            </router-link>
          </div>
