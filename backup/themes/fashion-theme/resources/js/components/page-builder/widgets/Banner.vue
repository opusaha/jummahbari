<template>
  ...
  <section class="product-banner product-banner-overflow-auto">
    ...
    <div class="slider-container" v-else>
      <swiper v-if="properties && Object.keys(properties).length > 0" :slidesPerView="'auto'" :direction="'horizontal'"
        :rtl="true" :loop="true" :spaceBetween="20" :modules="modules" :autoplay="{
          delay: 2000,
          disableOnInteraction: false,
          pauseOnMouseEnter: true,
        }" :pagination="{
          clickable: true,
        }" @onSlideChange="onSlideChange" class="mySwiper theme-slider-dots dots-bottom-30">
