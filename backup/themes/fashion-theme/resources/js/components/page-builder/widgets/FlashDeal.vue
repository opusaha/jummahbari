<template>
  <section class="deals-section home-page-section">
    <div class="row align-items-center my-3 gy-2">
      <div class="col-md-6">
        <section-title class="section-title mb-0" :title="title" />
      </div>
      <div
        class="col-md-6 d-flex flex-wrap justify-content-between justify-content-md-end align-items-center gap-2 gap-md-4">
