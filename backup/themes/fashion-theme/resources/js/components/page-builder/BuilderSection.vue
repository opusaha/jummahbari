<template>
  ...
  <section v-for="(section, index) in sections" :class="'builder-section ' + sectionVisibility(section)"
    :style="mobileSectionGapStyle(index, sections.length)"
  ...
  <section class="builder-section" :style="mobileServiceSectionStyle()" v-if="!isEmpty(findServiceFeatureProperties())">
...
export default {
  ...
  methods: {
    ...
    /**
     * Keep section-to-section spacing tight and equal on mobile.
     */
    mobileSectionGapStyle(index, total) {
      if (!this.isMobileScreen()) {
        return "";
      }
      const isLast = index === total - 1;
      return `margin-top:0 !important; margin-bottom:${isLast ? 0 : 4}px !important; padding-top:0 !important; padding-bottom:0 !important; border-top:0 !important;`;
    },

    mobileServiceSectionStyle() {
      if (!this.isMobileScreen()) {
        return "";
      }
      return "margin-top:0 !important; margin-bottom:0 !important; padding-top:0 !important; padding-bottom:0 !important; border-top:0 !important;";
    },
...
@media (max-width: 767px) {
  .builder-section > .custom-container2,
