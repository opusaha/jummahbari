...
import SiteInfoWidget from "../widget/SiteInfoWidget.vue";
import footer_left_menu from "../widget/FooterMenu.vue";
import footer_right_menu from "../widget/footer_right_menu.vue";
import newsletter_widget from "../widget/NewsletterWidget.vue";
