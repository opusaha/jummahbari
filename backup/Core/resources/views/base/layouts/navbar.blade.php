<nav class="sidebar" data-trigger="scrollbar">
    ...
    <div class="sidebar-body main-side-bar">
        ...
        <ul class="nav" id="main-nav">
            ...
            @canany(['Show Blog', 'Create Blog', 'Manage Category', 'Manage Tag', 'Manage Comment'])
                <li
                    ...
                    <a href="#">
                        ...
                        <span class="link-title">{{ translate('Blogs') }}</span>
                    </a>
                    <ul class="nav sub-menu">
                        ...
                        @can('Manage Blog Settings')
                            <li class="{{ Request::routeIs(['core.blog.comment.setting']) ? 'sub-menu-opened' : '' }}">
                                <a href="#">
            ...
            @if (auth()->user()->can('Manage Media'))
                <!--Media Module-->
                <li class="{{ Request::routeIs(['core.contact.messages']) ? 'active ' : '' }}">
                    <a href="{{ route('core.contact.messages') }}">
                        <i class="icofont-inbox"></i>
                        <span class="link-title">{{ translate('Messages') }}</span>
                    </a>
                </li>
                <!--End Media module-->
            @endif
            ...
            <!--System Module--->
            <li
                class="{{ Request::routeIs(['core.license.list', 'core.language.frontend.translations', 'core.language.edit', 'core.language.key.values', 'core.languages', 'core.language.new', 'core.system.update.page', 'core.backup.files.list', 'core.backup.database.list']) ? 'active sub-menu-opened' : '' }}">
                <a href="#">
                ...
                <ul class="nav sub-menu">
                    ...
                    @endif
                    @if (auth()->user()->can('Manage License'))
                        <li class="{{ Request::routeIs(['core.license.list']) ? 'active ' : '' }}">
                            <a href="{{ route('core.license.list') }}">{{ translate('Licenses') }}</a>
                        </li>
                    @endif
                </ul>
            </li>
