                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-12 row my-3">
                        ...
                        <div class="col-md-9">
                            <input type="checkbox" class="mb-2" name="default_comment_status" id="default_comment_status"
                                value="1" {{ get_setting('default_comment_status') == 1 ? 'checked' : '' }}>
                        ...
                        <div class="col-md-9">
                            <div class="mb-3">
                                <input type="checkbox" class="" name="require_name_email" id="require_name_email"
                                    value="1" {{ get_setting('require_name_email') == 1 ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                <input type="checkbox" class="" name="comment_registration" id="comment_registration"
                                    value="1" {{ get_setting('comment_registration') == 1 ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                <input type="checkbox" class="" name="close_comments_for_old_blogs"
                                    ...
                                    {{ get_setting('close_comments_for_old_blogs') == 1 ? 'checked' : '' }}>
                                ...
                                <label for="close_comments_for_old_blogs" class="black d-inline">
                                    ...
                                    <input type="number" name="close_comments_days_old" step="1" min="0"
                                        id="small_field" value="{{ get_setting('close_comments_days_old') }}">
                                    {{ translate('days') }}
                                </label>
                            ...
                            <div class="mb-3">
                                <input type="checkbox" class="" name="thread_comments" id="thread_comments"
                                    value="1" {{ get_setting('thread_comments') == 1 ? 'checked' : '' }}>
                                <label for="thread_comments"
                                    ...
                                    <select name="thread_comments_level" id="" class="small_select black">
                                        <option value="2"
                                            {{ get_setting('thread_comments_level') == '2' ? 'selected' : '' }}>2
                                        </option>
                                        <option value="3"
                                            {{ get_setting('thread_comments_level') == '3' ? 'selected' : '' }}>3
                                        </option>
                                        <option value="4"
                                            {{ get_setting('thread_comments_level') == '4' ? 'selected' : '' }}>4
                                        </option>
                                        <option value="5"
                                            {{ get_setting('thread_comments_level') == '5' ? 'selected' : '' }}>5
                                        </option>
                                        <option value="6"
                                            {{ get_setting('thread_comments_level') == '6' ? 'selected' : '' }}>6
                                        </option>
                                        <option value="7"
                                            {{ get_setting('thread_comments_level') == '7' ? 'selected' : '' }}>7
                                        </option>
                                        <option value="8"
                                            {{ get_setting('thread_comments_level') == '8' ? 'selected' : '' }}>8
                                        </option>
                                        <option value="9"
                                            {{ get_setting('thread_comments_level') == '9' ? 'selected' : '' }}>9
                                        </option>
                                        <option value="10"
                                            {{ get_setting('thread_comments_level') == '10' ? 'selected' : '' }}>
                                            10
                                        </option>
                                    </select>
                            ...
                            <div class="mb-3">
                                <label for="page_comments" class="black d-inline">
                                    ...
                                    <select name="comment_order" id="" class="small_select black">
                                        <option value="2" {{ get_setting('comment_order') == '2' ? 'selected' : '' }}>
                                            {{ translate('older') }}
                                        </option>
                                        <option value="1" {{ get_setting('comment_order') == '1' ? 'selected' : '' }}>
                                            {{ translate('newer') }}
                                        </option>
                                    </select>
                    ...
                    <div class="col-md-12 row my-3">
                        ...
                        <div class="col-md-9">
                            <input type="checkbox" class="mb-3" name="comments_notify_email" id="comments_notify_email"
                                value="1" {{ get_setting('comments_notify_email') == 1 ? 'checked' : '' }}>
                            ...
                            <input type="checkbox" class="mb-2" name="comments_moderation_notify_email"
                                ...
                                {{ get_setting('comments_moderation_notify_email') == 1 ? 'checked' : '' }}>
                    ...
                    <div class="col-md-12 row my-3">
                        ...
                        <div class="col-md-9">
                            <input type="checkbox" class="mb-3" name="comment_moderation" id="comment_moderation"
                                value="1" {{ get_setting('comment_moderation') == 1 ? 'checked' : '' }}>
                            ...
                            <input type="checkbox" class="mb-2" name="comment_previously_approved"
                                ...
                                {{ get_setting('comment_previously_approved') == 1 ? 'checked' : '' }}>
                        ...
                        <div class="col-md-9">
                            <p class="black mb-2">{{ translate('Hold a comment in the queue if it contains') }}
                                <input type="number" name="comment_max_links" step="1" id="small_field"
                                    value="{{ get_setting('comment_max_links') }}">
                            ...
                            <textarea name="comment_moderation_keys" id="comment_textarea" class="theme-input-style style--two" rows="5">{{ get_setting('comment_moderation_keys') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 row mt-5">
                        ...
                        <div class="col-md-9">
                            ...
                            <textarea name="comment_disallowed_keys" id="comment_textarea" class="theme-input-style style--two" rows="5">{{ get_setting('comment_disallowed_keys') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 row my-3">
                        ...
                        <div class="col-md-9">
                            <input type="checkbox" class="mb-3" name="show_avatars" id="show_avatars" value="1"
                                {{ get_setting('show_avatars') == 1 ? 'checked' : '' }}>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="mb-2">
                                <input type="radio" class="mb-3" name="avatar_default" id="mystery"
                                    value="mystery" {{ get_setting('avatar_default') == 'mystery' ? 'checked' : '' }}>
                            ...
                            <div class="mb-2">
                                <input type="radio" class="mb-3" name="avatar_default" id="blank"
                                    value="blank" {{ get_setting('avatar_default') == 'blank' ? 'checked' : '' }}>
                            ...
                            <div class="mb-2">
                                <input type="radio" class="mb-3" name="avatar_default" id="gravatar"
                                    value="gravatar" {{ get_setting('avatar_default') == 'gravatar' ? 'checked' : '' }}>
                            ...
                            <div class="mb-2">
                                <input type="radio" class="mb-3" name="avatar_default" id="identicon"
                                    value="identicon" {{ get_setting('avatar_default') == 'identicon' ? 'checked' : '' }}>
                            ...
                            <div class="mb-2">
                                <input type="radio" class="mb-3" name="avatar_default" id="wavatar"
                                    value="wavatar" {{ get_setting('avatar_default') == 'wavatar' ? 'checked' : '' }}>
                            ...
                            <div class="mb-2">
                                <input type="radio" class="mb-3" name="avatar_default" id="monsterid"
                                    value="monsterid" {{ get_setting('avatar_default') == 'monsterid' ? 'checked' : '' }}>
                            ...
                            <div class="">
                                <input type="radio" class="mb-3" name="avatar_default" id="retro"
                                    value="retro" {{ get_setting('avatar_default') == 'retro' ? 'checked' : '' }}>
