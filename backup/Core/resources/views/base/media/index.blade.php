...
@section('custom_scripts')
    ...
    <script src="{{ asset('/public/web-assets/backend/plugins/datepicker/datepicker.min.js') }}"></script>
    <script src="{{ asset('/public/web-assets/backend/plugins/datepicker/custom-form-datepicker.js') }}"></script>
    <script>
        (function($) {
            "use strict";
            initDropzone()
