            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('core.store.media.settings') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row mb-20">
                            ...
                            <div class="col-sm-8">
                                <select name="file_storage" class="theme-input-style file_storage_option">
                                    <option value="public" @if (get_setting('file_storage') == 'public') selected @endif>
                                        {{ translate('Local') }}
                                    </option>
                                    <option value="amazons3" @if (get_setting('file_storage') == 'amazons3') selected @endif>
                                        {{ translate('Amazon S3') }}
                                    </option>
                                </select>
                            ...
                            <div class="col-md-8">
                                <label class="switch glow primary medium">
                                    <input type="checkbox" name="watermark_status" id="watermark_status"
                                        @checked(get_setting('watermark_status') == 'on')>
                        ...
                        <div
                            class="form-row mb-20 watermark_image_settings {{ get_setting('watermark_status') == 'on' ? '' : 'd-none' }}">
                            <div class="col-md-4">
                        ...
                        <div
                            ...
                            <div class="col-md-8">
                                <select class="theme-input-style" name="watermark_image_position">
                                    <option value="top-left" class="text-uppercase" @selected(get_setting('watermark_image_position') == 'top-left')>
                                        {{ translate('Top Left') }}
                                    </option>
                                    <option value="top" class="text-uppercase" @selected(get_setting('watermark_image_position') == 'top')>
                                        {{ translate('Top') }}
                                    </option>
                                    <option value="top-right" class="text-uppercase" @selected(get_setting('watermark_image_position') == 'top-right')>
                                        {{ translate('Top Right') }}
                                    </option>
                                    <option value="left" class="text-uppercase" @selected(get_setting('watermark_image_position') == 'left')>
                                        {{ translate('Left') }}
                                    </option>
                                    <option value="center" class="text-uppercase" @selected(get_setting('watermark_image_position') == 'center')>
                                        {{ translate('Center') }}
                                    </option>
                                    <option value="right" class="text-uppercase" @selected(get_setting('watermark_image_position') == 'right')>
                                        {{ translate('Right') }}
                                    </option>
                                    <option value="bottom-left" class="text-uppercase" @selected(get_setting('watermark_image_position') == 'bottom-left')>
