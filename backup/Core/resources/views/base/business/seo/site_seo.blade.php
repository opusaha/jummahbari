                    ...
                    <div class="form-wrapper p-3">
                        <form action="{{ route('core.seo.settings.update') }}" method="POST">
                            ...
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-8">
                                    <textarea name="site_meta_description" class="theme-input-style">{{ get_setting('site_meta_description') }}</textarea>
                            ...
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-8">
                                    <textarea name="site_meta_keywords" class="theme-input-style">{{ get_setting('site_meta_keywords') }}</textarea>
                            ...
                            <div class="form-row mb-20">
                                ...
                                <div class="col-md-8">
                                    @include('core::base.includes.media.media_input', [
                                        ...
                                        'data' => get_setting('site_meta_image'),
                                    ])
