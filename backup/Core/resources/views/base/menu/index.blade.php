@php
    ...
    $pageRepo = new \Core\Repositories\PageRepository();
    $blogRepo = new \Core\Repositories\BlogRepository();

    $all_pages = $pageRepo->getAllPages();
    $all_recent_pages = $pageRepo->getAllRecentPages();

    $all_categories = $blogRepo->getAllCategories();
    $all_recent_categories = $blogRepo->getAllRecentCategories();

    $all_posts = $blogRepo->getAllPosts();
    $all_recent_posts = $blogRepo->getAllRecentPosts();

    $all_tags = $blogRepo->getAllTagsForMenu();
    $all_recent_tags = $blogRepo->getAllRecentTagsForMenu();
@endphp
